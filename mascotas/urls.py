...
urlpatterns = [
    ...
    # -----------------------------
    path('adoptar/<int:mascota_id>/', views.solicitar_adopcion, name='solicitar_adopcion'),
    ...
    path("blog/<int:pk>/eliminar/", views.eliminar_publicacion, name="eliminar_publicacion"),
